...
/*
     FILE ARCHIVED ON 13:13:42 Jun 5, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:30:03 Jan 28, 2016.
...
Text marker code 
Ashok Hariharan
/web/20150605131342/http://www.unganisha.org/home/pages/dhtmlmarker/

Butchered by Chris Maunder to allow multiple word match
and preservation of search word case. /web/20150605131342/http://www.codeproject.com
*/
...
function social() {
	...
	this.sns=[
	 {name:'Twitter',		image: 'AddTo_Twitter.gif',		url: '/web/20150605131342/http://twitter.com/home?',			urlVar: 'status', titleVar: '',		noteVar: '', urlPre:'Currently reading ', returnVar: '', otherVars: '' },
	 {name:'Digg',			image: 'AddTo_Digg.png',		url: '/web/20150605131342/http://digg.com/submit?',				urlVar: 'url',	titleVar: '',		noteVar: '', urlPre:'',	returnVar: '',	otherVars: '&phase=2' },
	 {name:'Facebook',		image: 'AddTo_Facebook.png',	url: '/web/20150605131342/http://www.facebook.com/sharer.php?', urlVar: 'u',	titleVar: 't',		noteVar: '', urlPre:'',	returnVar: '', otherVars: '' },
	 {name:'Del.icio.us',	image: 'AddTo_Delicious.png',	url: '/web/20150605131342/http://del.icio.us/post?',			urlVar: 'url',	titleVar: 'title',	noteVar: '', urlPre:'',	returnVar: '',	otherVars: '' },
	 {name:'Reddit',		image: 'AddTo_Reddit.png',		url: '/web/20150605131342/http://reddit.com/submit?',			urlVar: 'url',	titleVar: 'title',	noteVar: '', urlPre:'',	returnVar: '',	otherVars: '' },
	 {name:'Stumbleupon',	image: 'AddTo_stumbleupon.png',	url: '/web/20150605131342/http://www.stumbleupon.com/submit?',	urlVar: 'url',	titleVar: 'title',	noteVar: '', urlPre:'',	 returnVar: '',	otherVars: '' },
	 {name:'Newsvine',		image: 'AddTo_Newsvine.png',	url: '/web/20150605131342/http://www.newsvine.com/_wine/save?',	urlVar: 'u',	titleVar: '',		noteVar: '', urlPre:'',	returnVar: '',	otherVars: '&popoff=0' },
	 {name:'Technorati',	image: 'AddTo_Technorati.png',	url: '/web/20150605131342/http://technorati.com/faves?',		urlVar: 'add',	titleVar: '',		noteVar: '', urlPre:'',	returnVar: '',	otherVars: '' },
	 {name:'Mr. Wong',		image: 'AddTo_MrWong.png',		url: '/web/20150605131342/http://www.mister-wong.com/index.php?',urlVar: 'bm_url',	titleVar: 'bm_description',	noteVar: '', urlPre:'',	returnVar: '', otherVars: '&action=addurl' },
	 {name:'Yahoo!',		image: 'AddTo_Yahoo.png',		url: '/web/20150605131342/http://myweb2.search.yahoo.com/myresults/bookmarklet?', urlVar: 'u', titleVar: 't',	noteVar: '', urlPre:'',	returnVar: '', otherVars: '&d=&ei=UTF-8' },
	 {name:'Google',		image: 'AddTo_Google.png',		url: '/web/20150605131342/http://www.google.com/bookmarks/mark?', urlVar: 'bkmk', titleVar: 'title',noteVar: '', urlPre:'',	returnVar: '',	otherVars: '&op=edit' },
	 {name:'Windows Live',	image: 'AddTo_Live.png',		url: '/web/20150605131342/https://favorites.live.com/quickadd.aspx?', urlVar: 'url', titleVar: 'title',	noteVar: '', urlPre:'',	returnVar: '',	otherVars: '&marklet=1&mkt=en-us&top=1' },
...
//	 {name:'Blink',			image: 'AddTo_Blink.png',		url: '/web/20150605131342/http://www.blinklist.com/index.php?', urlVar: 'url',	titleVar: 'title',	noteVar: 'description', urlPre:'',	returnVar: '', otherVars: '&Action=Blink/addblink.php' },
//	 {name:'Furl',			image: 'AddTo_Furl.png',		url: '/web/20150605131342/http://www.furl.net/storeIt.jsp?',	urlVar: 'u',	titleVar: 't',		noteVar: '', urlPre:'',	returnVar: '',	otherVars: '' },
//	 {name:'Simpy',			image: 'AddTo_Simpy.png',		url: '/web/20150605131342/http://simpy.com/simpy/LinkAdd.do?',	urlVar: 'href',	titleVar: 'title',	noteVar: 'note', urlPre:'',	 returnVar: '_doneURI', otherVars: '&v=6&src=bookmarklet' },
	];
...
$(document).ready(function () {
	notificationAlert = new NotificationAlert(parent, 'elementId', '/web/20150605131342/http://mydomain.com/ajax');
 ...
 * along with Flowplayer.  If not, see </web/20150605131342/http://www.gnu.org/licenses/>.
 *
	...
	window.flowplayer = window.$f = function () {
		...
		if (arguments.length > 1) {
			...
			t = i({
				bgcolor: "#000000",
				version: [9, 0],
				expressInstall: "/web/20150605131342/http://static.flowplayer.org/swf/expressinstall.swf",
				cachebusting: false
			}, t);
			if (typeof o == "string") {
				if (o.indexOf(".") != -1) {
...
(function () {
	var h = document.all,
		j = "/web/20150605131342/http://www.adobe.com/go/getflashplayer",
...
var staticServer       = "/web/20150605131342/http://s.codeproject.com";
...
$(document).ready(function () {
	...
	forumMsgFlag.updateMessageUrl = "/web/20150605131342/http://localhost/script/Forums/Ajax/UpdateMessageFlag.aspx";
...
/*
 ...
 Team: @dbox, @seagoat
 Site: /web/20150605131342/http://www.kurtnoble.com/labs/rrssb
 Twitter: @therealkni
